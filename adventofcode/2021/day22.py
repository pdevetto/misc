...
data_exo = readfile("C:\\Users\\amlaw\\data\\d22.txt")
data_exemple=["nope",
...
#eng = procedure(data_exo)

data_exemple = readfile("C:\\Users\\amlaw\\data\\d22_exemple.txt")
...
print("overlap([0,6,0,6,0,6], [6,7,0,6,0,6], False)")
assert overlap([0,6,0,6,0,6], [6,7,0,6,0,6], False) == [[0, 5, 0, 6, 0, 6]]
print("overlap([0,3,0,3,0,3], [0,10,0,2,0,3], True)")
assert overlap([0,3,0,3,0,3], [0,10,0,2,0,3], True) == [[0, 3, 3, 3, 0, 3]]
print("overlap([0,3,0,3,0,3], [0,10,0,4,0,3], True)", overlap([0,3,0,3,0,3], [0,10,0,4,0,3], True))
assert overlap([0,3,0,3,0,3], [0,10,0,4,0,3], True) == []
print(overlap([0,3,0,3,0,3], [1,10,0,4,0,3], True))
...
overlap([-20, 26, -36, 17, -47, -27],[-20, 26, -36, 17, -47, -39], True) == [[-20, 26, -36, 17, -47, -27]]
overlap([-20, 26, -36, 17, -47, -27],[-20, 26, -36, -30, -38, -27], True) == [[-20, 26, -36, 17, -47, -27]]

nres = overlap([0,6,0,6,0,6], [6,9,2,4,2,4], True)
assert compt(nres) == 334
print(nres)
#assert nres == [[0,5,0,6,0,6],[]]
