...
assert day03(["( 2 , 4 )"]) == 0
assert day03(["xmul(2,4)%&mul[3,7]!@^do_not_mul(5,5)+mul(32,64]then(mul(11,8)mul(8,5))"]) == 161
...
assert day03b(["xmul(2,4)&mul[3,7]!^don't()_mul(5,5)+mul(32,64](mul(11,8)undo()?mul(8,5))"]) == 48
print(day03b(data))